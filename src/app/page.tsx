          ...
          <section className="relative overflow-hidden px-5 pb-24 pt-32 lg:px-8 lg:pb-32 lg:pt-40 3xl:pb-40 3xl:pt-48">
            ...
            <div className="relative mx-auto max-w-4xl text-center 3xl:max-w-5xl">
              ...
              <TypewriterWrapper delay={0.2} className="text-[clamp(2.25rem,6vw,4rem)] font-extrabold leading-[1.05] tracking-[-0.04em] 3xl:text-[4.5rem] 4xl:text-[5rem]">
                <TypewriterChild variants={childVariant} className="inline-block bg-gradient-to-r from-emerald-400 via-teal-300 to-emerald-400 bg-[length:200%_auto] bg-clip-text text-transparent">Trí&nbsp;</TypewriterChild>
                <TypewriterChild variants={childVariant} className="inline-block bg-gradient-to-r from-emerald-400 via-teal-300 to-emerald-400 bg-[length:200%_auto] bg-clip-text text-transparent">tuệ&nbsp;</TypewriterChild>
                <TypewriterChild variants={childVariant} className="inline-block bg-gradient-to-r from-emerald-400 via-teal-300 to-emerald-400 bg-[length:200%_auto] bg-clip-text text-transparent">chuyên&nbsp;</TypewriterChild>
                <TypewriterChild variants={childVariant} className="inline-block bg-gradient-to-r from-emerald-400 via-teal-300 to-emerald-400 bg-[length:200%_auto] bg-clip-text text-transparent">sâu</TypewriterChild>
                <br />
                    ...
                    <div className="flex items-center gap-3 rounded-xl border border-white/5 bg-auth-elevated/80 px-4 py-3.5">
                      ...
                      <TypewriterWrapper delay={1.2}>
                        <span className="text-sm text-auth-text-3">
                          ...
                          <TypewriterChild variants={childVariant} className="inline-block text-emerald-400">microservices&nbsp;</TypewriterChild>
                          ...
                          <TypewriterChild variants={childVariant} className="inline-block">e-commerce?&quot;</TypewriterChild>
                        </span>
                      </TypewriterWrapper>
                    </div>
